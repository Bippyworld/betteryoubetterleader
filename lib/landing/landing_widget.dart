    ...
    return StreamBuilder<List<DailyPostsRecord>>(
      stream: queryDailyPostsRecord(
        queryBuilder: (dailyPostsRecord) =>
            dailyPostsRecord.where('EDate', isLessThan: getCurrentTimestamp),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<DailyPostsRecord> landingDailyPostsRecordList = snapshot.data;
        // Return an empty Container when the document does not exist.
        if (snapshot.data.isEmpty) {
          return Container();
        }
        final landingDailyPostsRecord = landingDailyPostsRecordList.isNotEmpty
            ? landingDailyPostsRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
                        ...
                        Container(
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                Html(
                                  data: landingDailyPostsRecord.post,
                                ),
                              ],
                            ),
                          ),
